    ...
    classes: [
      {
        ...
        students: [
          { id: 1001, name: 'Jordan Lee',   grade: 9,  scores: [78, 82, 75], topics: ['Essays','Grammar','Poetry'] },
          { id: 1002, name: 'Priya Sharma',  grade: 9,  scores: [90, 93, 88], topics: ['Essays','Grammar','Poetry'] },
    ...
    classes: [
      {
        ...
        students: [
          { id: 1003, name: 'Marcus Webb',   grade: 9,  scores: [62, 68, 71], topics: ['Cell Bio','Genetics','Evolution'] },
